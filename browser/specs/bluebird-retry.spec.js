(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        // like Node.
        module.exports = factory(require('bluebird'), require('chai'), require('bluebird-retry'));
    } else {
        // Browser globals
        this.bluebird_retry_specs = factory(bluebird, chai, bluebirdretry);
    }
}(function (__external_bluebird, __external_chai, __external_bluebirdretry) {
    ...
    _require.modules = [
        ...
        function (module, exports) {
            var _ = _require(3);
            var Promise = _require(1);
            var expect = _require(2).expect;
            var retry = _require(0);
            var now = {
                    success: function () {
                        return true;
                    },
                ...
                _.each({
                    ...
                    describe(what, function () {
                        it('succeeds immediately', function (done) {
                            ...
                            return retry(countSuccess).then(function () {
                        ...
                        it('calculates max_tries based on timeout', function (done) {
                            ...
                            return retry(countSuccess, {
                                ...
                                expect(err.message).match(/operation timed out/);
                                expect(err.failure.message).match(/not yet/);    // Give a bit of leeway for bamboo
